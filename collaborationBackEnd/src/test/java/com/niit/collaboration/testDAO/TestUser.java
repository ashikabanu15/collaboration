...
public class TestUser 
{
	...
	public void testAdd()
	{
		...
		user.setUsername("ashikha");
		user.setFirst_name("ashikha");
		user.setLast_name("ashikha");
		user.setDob(new Date());
		user.setGender('F');
		user.setMail_id("ashikha@gmail.com");
